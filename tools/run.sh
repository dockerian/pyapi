...
#   GITHUB_REPO - the github repository name (default: pyapi)
#   GITHUB_USER - the github user (default: Infoblox-CTO)
#   DOCKER_USER - the docker user (default: infobloxcto)
#   DOCKER_NAME - default: pyapi, as in ${DOCKER_USER}/${DOCKER_NAME}
